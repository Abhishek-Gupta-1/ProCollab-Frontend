...
import { usePlagarism } from "@/hooks/use-plagarism";
import { 
Dialog ,
DialogContent, 
DialogDescription, 
...
const ProModal = () => {
  ...
  return (
    <Dialog open={Plagarrism.isOpen} onOpenChange={Plagarrism.onClose}>
            ...
            <DialogHeader>
                 <DialogTitle className="flex justify-center items-center flex-col gap-y-4 pb-2">
                    <div className="flex items-center">
                        Upgrade To Genious 
                        <Button className="uppercase text-sm py-1" >
                            Pro
                        </Button>
                    </div>
                 </DialogTitle>
